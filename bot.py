...
async def send_ad(update: Update, context: ContextTypes.DEFAULT_TYPE, seconds: int = 10):
    ...
    ads = [
        "🌟 **AD** | Need a VPN? Stay safe online → vpn-example.com",
        "💡 **AD** | Boost your Telegram channel → boostservice-example.com",
        "🎵 **AD** | Download music legally → musicapp-example.com",
        "📱 **AD** | Best phone deals this week → deals-example.com",
    ]
    import random
...
async def cmd_plan(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        f"📦 Max file size: `{'2 GB' if plan == 'premium' else '50 MB'}`\n"
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "main_menu":
        ...
        await query.edit_message_text(
            ...
            "• 📌 Download history\n\n"
            "**How to pay:**\n"
            "1️⃣ Open PhonePe / GPay / Paytm\n"
            "2️⃣ Send ₹399 to UPI: `8484028481-2@ybl`\n"
            "3️⃣ Screenshot your payment\n"
            "4️⃣ Send it to the admin below\n"
            "5️⃣ Get activated within 1 hour ✅",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("💬 Send Payment Proof", url="https://t.me/darshan0753m")],
                [InlineKeyboardButton("🏠 Back", callback_data="main_menu")],
            ])
        )
